 ...
 *
 * Aucune série temporelle : contrairement à YouTube ou Instagram, Discord ne renvoie que
 * des compteurs **courants**, relevés à chaque collecte et jamais archivés jour par jour.
 * Deux chiffres et l'heure du dernier relevé suffisent donc à tout dire.
 */
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="hidden lg:block">
          ...
          <p className="text-sm text-muted-foreground">
            {payload?.name || 'Le serveur suivi'} · relevé à chaque collecte, sans historique.
          </p>
        </div>
        <Button
          size="sm"
